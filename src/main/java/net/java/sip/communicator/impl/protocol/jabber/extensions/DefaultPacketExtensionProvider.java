 ...
 * @author Emil Ivov
 */
public class DefaultPacketExtensionProvider<C extends AbstractPacketExtension> extends DataPacketProvider.PacketExtensionProvider
{
    /**
    ...
    public C parseExtension(XmlPullParser parser) throws Exception
    {
        ...
        while (!done)
        {
            ...
            {
                DefaultPacketExtensionProvider provider = (DefaultPacketExtensionProvider) ProviderManager.getExtensionProvider(elementName, namespace);
                ...
                {
                    ExtensionElement childExtension = (ExtensionElement) provider.parseExtension(parser);
