    ...
    implements Comparable<CandidatePacketExtension>
{
    ...
    /**
     * The name of the "cost" element.
     */
    public static final String COST_ATTR_NAME = "cost";
    ...
    public int getCost()
    {
        return super.getAttributeAsInt(COST_ATTR_NAME);
    }
    ...
    {
        super.setAttribute(COST_ATTR_NAME, cost);
    }
