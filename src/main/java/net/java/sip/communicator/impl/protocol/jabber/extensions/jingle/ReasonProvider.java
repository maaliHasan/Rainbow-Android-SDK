 ...
 * @author Emil Ivov
 */
public class ReasonProvider extends DataPacketProvider.PacketExtensionProvider
{
    ...
    public ReasonPacketExtension parseExtension(XmlPullParser parser) throws Exception
    {
        ...
        ReasonPacketExtension reasonExt = new ReasonPacketExtension(reason, text, (ExtensionElement) null);
