 ...
 */
public class CallLogMessagePacketExtension extends DefaultExtensionElement implements ICallLogPacketExtension
{

    public static final String ELEMENT = "result";
    public static final String NAMESPACE = "jabber:iq:telephony:call_log";
    private static final String LOG_TAG = "CallLogMessagePacketExtension";
    private String id;
    private Long stampLong;

    private CallLogPacketExtension callLogEvent;

    public CallLogMessagePacketExtension(XmlPullParser parser)
    {
        ...
        //<result xmlns='jabber:iq:telephony:call_log' id='1494943960081007'>
    ...
    public String toString()
    {
        ...
        toXml.append("CallLogMessagePacketExtension{");
