...
public class RainbowDataForm implements ExtensionElement {
    ...
    public enum Type {
        ...
        public static DataForm.Type fromString(String string) {
            return DataForm.Type.valueOf(string.toLowerCase(Locale.US));
        }
    }

    private DataForm.Type type;
    private String title;
    private List<String> instructions = new ArrayList<String>();
    private DataForm.ReportedData reportedData;
    private final List<DataForm.Item> items = new ArrayList<DataForm.Item>();
    ...
    public RainbowDataForm(DataForm.Type type) {
        this.type = type;
    }
    ...
    public List<DataForm.Item> getItems() {
        synchronized (items) {
            return Collections.unmodifiableList(new ArrayList<DataForm.Item>(items));
        }
    }
     ...
     */
    public void setReportedData(DataForm.ReportedData reportedData) {
     ...
     */
    public void addItem(DataForm.Item item) {
        synchronized (items) {
            items.add(item);
        }
    }
    ...
    public XmlStringBuilder toXML() {
        ...
        for (DataForm.Item item : getItems()) {
